...
const navItems: NavItem[] = [
  { icon: <ChartBar />, to: "/", label: "Overview", end: true },

  {
    ...
    subItems: [
      { to: "/event-management/all-event", label: "All Event" },
      { to: "/event-management/create-new-event", label: "Create New Event" },
      { to: "/event-management/categories", label: "Category" },
      {
        to: "/event-management/reports",
        label: "Report",
        subItems: [
          { to: "/event-management/reports/participation", label: "Participation" },
          { to: "/event-management/reports/tournament-overview", label: "Tournament Overview" },
          { to: "/event-management/reports/player-performance", label: "Player Performance" },
          { to: "/event-management/reports/category-popularity", label: "Category Popularity" },
          { to: "/event-management/reports/team-ranking", label: "Team Ranking" },
        ],
      },
    ],
  },

  {
    ...
    subItems: [
      { to: "/user-management/user", label: "User" },
      { to: "/user-management/role", label: "Roles & Permission" },
    ],
  },
      ...
      <div key={item.to}>
        ...
        >
          ...
          <div className="flex items-center gap-3 w-full text-purple-700">
            ...
            {!collapsed && (
              <>
                <span className="flex-1 text-start text-purple-700">
                  {item.label}
                </span>
                {hasSubItems && (
                  <ChevronDown
